...
declare function zogr(item1, ...item2):string
declare function zogb(item1, ...item2):string
declare function zogy(item1, ...item2):string
declare function zogg(item1, ...item2):string
declare function zogp(item1, ...item2):string
declare function zogo(item1, ...item2):string
...
declare class Rectangle extends Container implements zimShape {
    constructor(config_or_width?:number|zimVee, height?:number|zimVee, color?:color|zimVee, borderColor?:color|zimVee, borderWidth?:number|zimVee, corner?:number|any[], dashed?:boolean|[number], strokeObj?:{}, style?:boolean, group?:string, inherit?:{})
    constructor(config:{width?:number|zimVee, height?:number|zimVee, color?:color|zimVee, borderColor?:color|zimVee, borderWidth?:number|zimVee, corner?:number|any[], dashed?:boolean|[number], strokeObj?:{}, style?:boolean, group?:string, inherit?:{}})
    // ZIM Shape Interface
    readonly shape:Shape
    color:color
    colorRange:number
...
declare class LabelOnArc extends Container implements zimComponent {
    constructor(config_or_label?:string|Label, size?:number, font?:string, color?:color, radius?:number, flip?:boolean, spacing?:number, letterSpacing?:number, angles?:number[], showCircle?:boolean, arcColor?:color, arcBorderColor?:color, arcBorderWidth?:number, style?:boolean, group?:string, inherit?:{})
    constructor(config:{label?:string|Label, size?:number, font?:string, color?:color, radius?:number, flip?:boolean, spacing?:number, letterSpacing?:number, angles?:number[], showCircle?:boolean, arcColor?:color, arcBorderColor?:color, arcBorderWidth?:number, style?:boolean, group?:string, inherit?:{}})
    // ZIM Component Interface
    // dispose():boolean // now added to Container, etc.
    enabled:boolean
    // END ZIM Component Interface
...
declare class Button extends Container implements zimComponent {
    constructor(config_or_width?:number, height?:number, label?:string|Label, backgroundColor?:color, rollBackgroundColor?:color, color?:color, rollColor?:color, borderColor?:color, borderRollColor?:color, borderWidth?:number, corner?:number|any[], shadowColor?:color, shadowBlur?:number, hitPadding?:number, gradient?:number, gloss?:number, dashed?:boolean|[number], backing?:DisplayObject, rollBacking?:DisplayObject, rollPersist?:boolean, icon?:DisplayObject, rollIcon?:DisplayObject, toggle?:string|boolean, toggleBackgroundColor?:color, rollToggleBackgroundColor?:color, toggleColor?:color, rollToggleColor?:color, toggleBacking?:DisplayObject, rollToggleBacking?:DisplayObject, toggleIcon?:DisplayObject, rollToggleIcon?:DisplayObject, toggleEvent?:string, wait?:string, waitTime?:boolean, waitBackgroundColor?:color, rollWaitBackgroundColor?:color, waitColor?:color, rollWaitColor?:color, waitModal?:boolean, waitEnabled?:boolean, waitBacking?:DisplayObject, rollWaitBacking?:DisplayObject, waitIcon?:DisplayObject, rollWaitIcon?:DisplayObject, align?:number, valign?:number, indent?:number, indentHorizontal?:number, indentVertical?:number, style?:boolean, group?:string, inherit?:{})
    constructor(config:{width?:number, height?:number, label?:string|Label, backgroundColor?:color, rollBackgroundColor?:color, color?:color, rollColor?:color, borderColor?:color, borderRollColor?:color, borderWidth?:number, corner?:number|any[], shadowColor?:color, shadowBlur?:number, hitPadding?:number, gradient?:number, gloss?:number, dashed?:boolean|[number], backing?:DisplayObject, rollBacking?:DisplayObject, rollPersist?:boolean, icon?:DisplayObject, rollIcon?:DisplayObject, toggle?:string|boolean, toggleBackgroundColor?:color, rollToggleBackgroundColor?:color, toggleColor?:color, rollToggleColor?:color, toggleBacking?:DisplayObject, rollToggleBacking?:DisplayObject, toggleIcon?:DisplayObject, rollToggleIcon?:DisplayObject, toggleEvent?:string, wait?:string, waitTime?:boolean, waitBackgroundColor?:color, rollWaitBackgroundColor?:color, waitColor?:color, rollWaitColor?:color, waitModal?:boolean, waitEnabled?:boolean, waitBacking?:DisplayObject, rollWaitBacking?:DisplayObject, waitIcon?:DisplayObject, rollWaitIcon?:DisplayObject, align?:number, valign?:number, indent?:number, indentHorizontal?:number, indentVertical?:number, style?:boolean, group?:string, inherit?:{}})
    // ZIM Component Interface
    // dispose():boolean // now added to Container, etc.
    enabled:boolean
    // END ZIM Component Interface
...
declare class Panel extends Container implements zimComponent {
    constructor(config_or_width?:number, height?:number, titleBar?:string|Label, titleBarColor?:color, titleBarBackroundColor?:color, titleBarHeight?:number, backgroundColor?:color, borderColor?:color, borderWidth?:number, corner?:number|any[], close?:boolean, closeColor?:color, arrow?:boolean, align?:string, shadowColor?:color, shadowBlur?:number, draggable?:boolean, boundary?:Boundary|{}, extraButton?:boolean, collapse?:boolean, collapsed?:boolean, style?:boolean, group?:string, inherit?:{})
    constructor(config:{width?:number, height?:number, titleBar?:string|Label, titleBarColor?:color, titleBarBackroundColor?:color, titleBarHeight?:number, backgroundColor?:color, borderColor?:color, borderWidth?:number, corner?:number|any[], close?:boolean, closeColor?:color, arrow?:boolean, align?:string, shadowColor?:color, shadowBlur?:number, draggable?:boolean, boundary?:Boundary|{}, extraButton?:boolean, collapse?:boolean, collapsed?:boolean, style?:boolean, group?:string, inherit?:{}})
    // ZIM Component Interface
    // dispose():boolean // now added to Container, etc.
    enabled:boolean
    // END ZIM Component Interface
...
declare class Pane extends Container implements zimComponent {
    constructor(config_or_width?:number, height?:number, label?:string|Label, backgroundColor?:color, color?:color, draggable?:boolean, resets?:boolean, modal?:boolean, corner?:number|any[], backdropColor?:color, shadowColor?:color, shadowBlur?:number, center?:boolean, displayClose?:boolean, backdropClose?:boolean, backing?:DisplayObject, fadeTime?:number, container?:Stage|Container, titleBar?:string|Label, titleBarColor?:color, titleBarBackroundColor?:color, titleBarHeight?:number, close?:boolean, closeColor?:color, style?:boolean, group?:string, inherit?:{})
    constructor(config:{width?:number, height?:number, label?:string|Label, backgroundColor?:color, color?:color, draggable?:boolean, resets?:boolean, modal?:boolean, corner?:number|any[], backdropColor?:color, shadowColor?:color, shadowBlur?:number, center?:boolean, displayClose?:boolean, backdropClose?:boolean, backing?:DisplayObject, fadeTime?:number, container?:Stage|Container, titleBar?:string|Label, titleBarColor?:color, titleBarBackroundColor?:color, titleBarHeight?:number, close?:boolean, closeColor?:color, style?:boolean, group?:string, inherit?:{}})
    // ZIM Component Interface
    // dispose():boolean // now added to Container, etc.
    enabled:boolean
    // END ZIM Component Interface
...
declare class ColorPicker extends Container implements zimComponent {
    constructor(config_or_width?:number, colors?:string[], cols?:number, spacing?:number, greyPicker?:boolean, alphaPicker?:boolean, startBackgroundColor?:color, draggable?:boolean, shadowColor?:color, shadowBlur?:number, buttonBar?:boolean, circles?:boolean, indicator?:boolean, backgroundColor?:color, keyArrows?:boolean, selectedIndex?:number, selectedColor?:string, style?:boolean, group?:string, inherit?:{})
...
declare class Style {
    ...
    static add(obj:{any}):void
    static addType(typeName:string, obj:{any}):void
    static addGroup(groupName:string, obj:{any}):void
...
declare class Swiper extends createjs.EventDispatcher {
    constructor (config_or_swipeOn:Stage|DisplayObject, target:Object, property:string, sensitivity?:number, swiperType?:string, min?:number, max?:number, damp?:number, integer?:boolean, factor?:number, pauseTime?:number)
    constructor (config:{swipeOn:Stage|DisplayObject, target:Object, property:string, sensitivity?:number, swiperType?:string, min?:number, max?:number, damp?:number, integer?:boolean, factor?:number, pauseTime?:number})
...
declare class Frame extends createjs.EventDispatcher {
    constructor(config_or_scaling?:string, width?:number, height?:number, color?:color, outerColor?:color, assets?:[string,{}]|string|{}, path?:string, progress?:Waiter|ProgressBar, rollover?:boolean, touch?:boolean, scrollTop?:boolean, align?:string, valign?:string, canvasID?:string, rollPerSecond?:number, delay?:number, canvasCheck?:boolean, gpu?:boolean, gpuObj?:boolean, nextFrame?:Frame, nextStage?:Stage, allowDefault?:boolean, loadFailObj?:DisplayObject, sensors?:boolean, retina?:boolean, mouseMoveOutside?:boolean, captureMouse?:boolean, shim?:{any})
    constructor(config:{scaling?:string, width?:number, height?:number, color?:color, outerColor?:color, assets?:[string,{}]|string|{}, path?:string, progress?:Waiter|ProgressBar, rollover?:boolean, touch?:boolean, scrollTop?:boolean, align?:string, valign?:string, canvasID?:string, rollPerSecond?:number, delay?:number, canvasCheck?:boolean, gpu?:boolean, gpuObj?:boolean, nextFrame?:Frame, nextStage?:Stage, allowDefault?:boolean, loadFailObj?:DisplayObject, sensors?:boolean, retina?:boolean, mouseMoveOutside?:boolean, captureMouse?:boolean, shim?:{any}})
...
declare function addWires({any}):{any}
...
export function addWires({any}):{any}
